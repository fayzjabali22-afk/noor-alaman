  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="relative flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-br from-emerald-500 via-teal-600 to-emerald-800 text-white shadow-2xl shadow-emerald-950/80 border border-emerald-400/50 hover:scale-105 active:scale-95 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-emerald-500/40 group cursor-pointer z-[99999]"
        style={{ zIndex: 99999 }}
